            ...
            <>
                      ...
                      {isCustomizing ? (
                          <div className="p-4 flex flex-col gap-3 flex-1 bg-bg-surface border-t border-border-light">
                            ...
                            <div className="flex flex-col gap-1.5 mt-2">
                              <button className="w-full py-2 bg-gradient-to-br from-accent to-accent-hover text-white font-bold rounded-lg shadow-sm hover:shadow-md uppercase tracking-wider text-[11px] transition-all cursor-pointer border-none" onClick={() => onSelect(design.id, useBackSide ? [pageSelection.front, pageSelection.back] : [pageSelection.front])}>
                                Confirm Import
                              </button>
              ...
              {designs.length === 0 && (
                <div className="py-12 text-center flex flex-col items-center gap-3">
                  ...
                  <button className="w-full py-3 bg-gradient-to-br from-accent to-accent-hover text-white font-bold rounded-lg shadow-sm hover:shadow-md uppercase tracking-wider text-xs hover:-translate-y-0.5 active:translate-y-0 transition-all duration-150 cursor-pointer max-w-[240px] border-none" onClick={handleCreateNew}>
